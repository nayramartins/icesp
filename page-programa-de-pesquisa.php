        ...
        <div class="pesquisa">
            ...
            <div class="quadrante">
                <div class="quadrante-item primeiro">
                    <a href="<?php customBlogUrl(); ?>/pt/quadrante/pesquisa-em-humanos">
                ...
                <div class="quadrante-item segundo">
                    <a href="<?php customBlogUrl(); ?>/pt/quadrante/inovacao-terapeutica-e-diagnostico">
                        <p><?php the_field('label_segundo_quadrante'); ?></p>
                        <img src="<?php the_field('imagem_segundo_quadrante'); ?>" />
                    </a>
                </div>
                <div class="quadrante-item terceiro">
                    <a href="<?php customBlogUrl(); ?>/pt/quadrante/epidemiologia-e-prevencao">
